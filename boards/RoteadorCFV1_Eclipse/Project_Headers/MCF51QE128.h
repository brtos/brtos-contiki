...
#define _KBI1SC (* (volatile KBI1SCSTR *) 0xFFFF800C)
...
#define _KBI1PE (* (volatile KBI1PESTR *) 0xFFFF800D)
...
#define _KBI1ES (* (volatile KBI1ESSTR *) 0xFFFF800E)
...
#define _IRQSC (* (volatile IRQSCSTR *) 0xFFFF800F)
...
#define _APCTL3 (* (volatile APCTL3STR *) 0xFFFF8019)
...
#define _ACMP1SC (* (volatile ACMP1SCSTR *) 0xFFFF801A)
...
#define _ACMP2SC (* (volatile ACMP2SCSTR *) 0xFFFF801B)
...
#define _PTGD (* (volatile PTGDSTR *) 0xFFFF801C)
...
#define _PTGDD (* (volatile PTGDDSTR *) 0xFFFF801D)
...
#define _PTHD (* (volatile PTHDSTR *) 0xFFFF801E)
...
#define _PTHDD (* (volatile PTHDDSTR *) 0xFFFF801F)
...
#define _SCI1BD (* (volatile SCI1BDSTR *) 0xFFFF8020)
...
#define _SCI1C1 (* (volatile SCI1C1STR *) 0xFFFF8022)
...
#define _SCI1C2 (* (volatile SCI1C2STR *) 0xFFFF8023)
...
#define _SCI1S1 (* (volatile SCI1S1STR *) 0xFFFF8024)
...
#define _SCI1S2 (* (volatile SCI1S2STR *) 0xFFFF8025)
...
#define _SCI1C3 (* (volatile SCI1C3STR *) 0xFFFF8026)
...
#define _SCI1D (* (volatile SCI1DSTR *) 0xFFFF8027)
...
#define _SPI1C1 (* (volatile SPI1C1STR *) 0xFFFF8028)
...
#define _SPI1C2 (* (volatile SPI1C2STR *) 0xFFFF8029)
...
#define _SPI1BR (* (volatile SPI1BRSTR *) 0xFFFF802A)
...
#define _SPI1S (* (volatile SPI1SSTR *) 0xFFFF802B)
...
#define _SPI1D (* (volatile SPI1DSTR *) 0xFFFF802D)
...
#define _PTJD (* (volatile PTJDSTR *) 0xFFFF802E)
...
#define _PTJDD (* (volatile PTJDDSTR *) 0xFFFF802F)
...
#define _IIC1A (* (volatile IIC1ASTR *) 0xFFFF8030)
...
#define _IIC1F (* (volatile IIC1FSTR *) 0xFFFF8031)
...
#define _IIC1C1 (* (volatile IIC1C1STR *) 0xFFFF8032)
...
#define _IIC1S (* (volatile IIC1SSTR *) 0xFFFF8033)
...
#define _IIC1D (* (volatile IIC1DSTR *) 0xFFFF8034)
...
#define _IIC1C2 (* (volatile IIC1C2STR *) 0xFFFF8035)
...
#define _ICSC1 (* (volatile ICSC1STR *) 0xFFFF8038)
...
#define _ICSC2 (* (volatile ICSC2STR *) 0xFFFF8039)
...
#define _ICSTRM (* (volatile ICSTRMSTR *) 0xFFFF803A)
...
#define _ICSSC (* (volatile ICSSCSTR *) 0xFFFF803B)
...
#define _KBI2SC (* (volatile KBI2SCSTR *) 0xFFFF803C)
...
#define _KBI2PE (* (volatile KBI2PESTR *) 0xFFFF803D)
...
#define _KBI2ES (* (volatile KBI2ESSTR *) 0xFFFF803E)
...
#define _TPM1SC (* (volatile TPM1SCSTR *) 0xFFFF8040)
...
#define _TPM1CNT (* (volatile TPM1CNTSTR *) 0xFFFF8041)
...
#define _TPM1MOD (* (volatile TPM1MODSTR *) 0xFFFF8043)
...
#define _TPM1C0SC (* (volatile TPM1C0SCSTR *) 0xFFFF8045)
...
#define _TPM1C0V (* (volatile TPM1C0VSTR *) 0xFFFF8046)
...
#define _TPM1C1SC (* (volatile TPM1C1SCSTR *) 0xFFFF8048)
...
#define _TPM1C1V (* (volatile TPM1C1VSTR *) 0xFFFF8049)
...
#define _TPM1C2SC (* (volatile TPM1C2SCSTR *) 0xFFFF804B)
...
#define _TPM1C2V (* (volatile TPM1C2VSTR *) 0xFFFF804C)
...
#define _TPM2SC (* (volatile TPM2SCSTR *) 0xFFFF8050)
...
#define _TPM2CNT (* (volatile TPM2CNTSTR *) 0xFFFF8051)
...
#define _TPM2MOD (* (volatile TPM2MODSTR *) 0xFFFF8053)
...
#define _TPM2C0SC (* (volatile TPM2C0SCSTR *) 0xFFFF8055)
...
#define _TPM2C0V (* (volatile TPM2C0VSTR *) 0xFFFF8056)
...
#define _TPM2C1SC (* (volatile TPM2C1SCSTR *) 0xFFFF8058)
...
#define _TPM2C1V (* (volatile TPM2C1VSTR *) 0xFFFF8059)
...
#define _TPM2C2SC (* (volatile TPM2C2SCSTR *) 0xFFFF805B)
...
#define _TPM2C2V (* (volatile TPM2C2VSTR *) 0xFFFF805C)
...
#define _TPM3SC (* (volatile TPM3SCSTR *) 0xFFFF8060)
...
#define _TPM3CNT (* (volatile TPM3CNTSTR *) 0xFFFF8061)
...
#define _TPM3MOD (* (volatile TPM3MODSTR *) 0xFFFF8063)
...
#define _TPM3C0SC (* (volatile TPM3C0SCSTR *) 0xFFFF8065)
...
#define _TPM3C0V (* (volatile TPM3C0VSTR *) 0xFFFF8066)
...
#define _TPM3C1SC (* (volatile TPM3C1SCSTR *) 0xFFFF8068)
...
#define _TPM3C1V (* (volatile TPM3C1VSTR *) 0xFFFF8069)
...
#define _TPM3C2SC (* (volatile TPM3C2SCSTR *) 0xFFFF806B)
...
#define _TPM3C2V (* (volatile TPM3C2VSTR *) 0xFFFF806C)
...
#define _TPM3C3SC (* (volatile TPM3C3SCSTR *) 0xFFFF806E)
...
#define _TPM3C3V (* (volatile TPM3C3VSTR *) 0xFFFF806F)
...
#define _TPM3C4SC (* (volatile TPM3C4SCSTR *) 0xFFFF8071)
...
#define _TPM3C4V (* (volatile TPM3C4VSTR *) 0xFFFF8072)
...
#define _TPM3C5SC (* (volatile TPM3C5SCSTR *) 0xFFFF8074)
...
#define _TPM3C5V (* (volatile TPM3C5VSTR *) 0xFFFF8075)
...
#define _SPMSC1 (* (volatile SPMSC1STR *) 0xFFFF9808)
...
#define _SPMSC2 (* (volatile SPMSC2STR *) 0xFFFF9809)
...
#define _SPMSC3 (* (volatile SPMSC3STR *) 0xFFFF980B)
...
#define _SCGC1 (* (volatile SCGC1STR *) 0xFFFF980E)
...
#define _SCGC2 (* (volatile SCGC2STR *) 0xFFFF980F)
...
#define _RTCSC (* (volatile RTCSCSTR *) 0xFFFF9830)
...
#define _RTCCNT (* (volatile RTCCNTSTR *) 0xFFFF9831)
...
#define _RTCMOD (* (volatile RTCMODSTR *) 0xFFFF9832)
...
#define _SPI2C1 (* (volatile SPI2C1STR *) 0xFFFF9838)
...
#define _SPI2C2 (* (volatile SPI2C2STR *) 0xFFFF9839)
...
#define _SPI2BR (* (volatile SPI2BRSTR *) 0xFFFF983A)
...
#define _SPI2S (* (volatile SPI2SSTR *) 0xFFFF983B)
...
#define _SPI2D (* (volatile SPI2DSTR *) 0xFFFF983D)
...
#define _IIC2A (* (volatile IIC2ASTR *) 0xFFFF9868)
...
#define _IIC2F (* (volatile IIC2FSTR *) 0xFFFF9869)
...
#define _IIC2C1 (* (volatile IIC2C1STR *) 0xFFFF986A)
...
#define _IIC2S (* (volatile IIC2SSTR *) 0xFFFF986B)
...
#define _IIC2D (* (volatile IIC2DSTR *) 0xFFFF986C)
...
#define _IIC2C2 (* (volatile IIC2C2STR *) 0xFFFF986D)
...
#define _SCI2BD (* (volatile SCI2BDSTR *) 0xFFFF9870)
...
#define _SCI2C1 (* (volatile SCI2C1STR *) 0xFFFF9872)
...
#define _SCI2C2 (* (volatile SCI2C2STR *) 0xFFFF9873)
...
#define _SCI2S1 (* (volatile SCI2S1STR *) 0xFFFF9874)
...
#define _SCI2S2 (* (volatile SCI2S2STR *) 0xFFFF9875)
...
#define _SCI2C3 (* (volatile SCI2C3STR *) 0xFFFF9876)
...
#define _SCI2D (* (volatile SCI2DSTR *) 0xFFFF9877)
...
#define _PTCSET (* (volatile PTCSETSTR *) 0xFFFF9878)
...
#define _PTESET (* (volatile PTESETSTR *) 0xFFFF9879)
...
#define _PTCCLR (* (volatile PTCCLRSTR *) 0xFFFF987A)
...
#define _PTECLR (* (volatile PTECLRSTR *) 0xFFFF987B)
...
#define _PTCTOG (* (volatile PTCTOGSTR *) 0xFFFF987C)
...
#define _PTETOG (* (volatile PTETOGSTR *) 0xFFFF987D)
...
#define _INTC_FRC (* (volatile INTC_FRCSTR *) 0xFFFFFFD3)
