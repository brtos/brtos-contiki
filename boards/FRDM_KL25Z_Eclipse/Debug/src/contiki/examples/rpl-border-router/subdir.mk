...
C_SRCS += \
../src/contiki/examples/rpl-border-router/border-router.c \
../src/contiki/examples/rpl-border-router/httpd-simple.c \
../src/contiki/examples/rpl-border-router/slip-bridge.c 

OBJS += \
./src/contiki/examples/rpl-border-router/border-router.o \
./src/contiki/examples/rpl-border-router/httpd-simple.o \
./src/contiki/examples/rpl-border-router/slip-bridge.o 

C_DEPS += \
./src/contiki/examples/rpl-border-router/border-router.d \
./src/contiki/examples/rpl-border-router/httpd-simple.d \
./src/contiki/examples/rpl-border-router/slip-bridge.d 


# Each subdirectory must supply rules for building sources it contributes
src/contiki/examples/rpl-border-router/%.o: ../src/contiki/examples/rpl-border-router/%.c
	@echo 'Building file: $<'
